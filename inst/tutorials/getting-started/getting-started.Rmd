...
This is your hands on introduction to the basics of working with [dartR](https://github.com/green-striped-gecko/dartRverse?tab=readme-ov-file#dartrverse-). The eBook [[Getting Started with dartR](http://dartr.biomatix.org/dartR)]{style="color:#ff0000;"} covers the basic theory in a series of Chapters. 

### Worked Examples

Having covered the theory in each Chapter, the eBook links to the Worked Examples listed below. These take you by the hand to progress through examples using RCode Boxes. This also provides the flexibility for you to repeat the analyses in the RStudio Editor or to branch out and follow any ideas or other analyses that might strike you as interesting on the way. 
...
The Exercises listed below are referred to in the eBook [[Getting Started with dartR](http://dartr.biomatix.org/dartR)]{style="color:#ff0000;"} and are associated with particular Chapters. You will be directed to these as you progress through the eBook. 
...
Each RCode box is independent so that code you ran in one will normally not be recognised by another. If you modify code in the RCode boxes, this might cause some issues.
...
## Worked Ex 2-1: Data Structures {data-progressive="true"}
...
### Winding up {data-progressive="false"}
...
[Next Topic](#worked-ex-2-2-io){.menuButton}


## Worked Ex 2-2: I/O {data-progressive="true"}
