...
This is your hands on introduction to the basics of working with [dartR](https://github.com/green-striped-gecko/dartRverse?tab=readme-ov-file#dartrverse-). The eBook [[Getting Started with dartR](http://dartr.biomatix.org/dartR)]{style="color:#ff0000;"} covers the basic theory in a series of Chapters. The eBook then links to the Worked Examples provided here. These take you by the hand to progress through some examples which allows you to repeat the analyses in the RStudio Editor or to branch out and follow any ideas or other analyses that might strike you as interesting on the way. 

### Worked Examples

The Worked Examples listed below are referred to in the eBook [[Getting Started with dartR](http://dartr.biomatix.org/dartR)]{style="color:#ff0000;"}. You will be directed to these as you progress through the eBook. 
...
The Exercises listed below are referred to in the eBook [[Getting Started with dartR](http://dartr.biomatix.org/dartR)]{style="color:#ff0000;"} and associated with particular Chapters. You will be directed to these as you progress through the eBook. 

**List of Exercises**

- [Exercise 3-1: Reading in 1-Row Format]
- [Exercise 3-2: Reading in SilicoDArT Data]
- [Exercise 3-3. Reading in vcf data (Arabian Oryx)]
- [Exercise 4-1: Assessing SNP Data]
- [Exercise 4-2: Assessing SilicoDArT Data]
- [Exercise 4-3: Using Recode Tables]
- [Exercise 4-4: Examining Platypus SNP Data]
- [Exercise 4-5: QC on the Platypus Data]
- [Exercise 4-6: Sub-setting the Platypus Data]
- [Exercise 5-1: Filtering the Platypus Dataset]
- [Exercise 5-2: Filtering the Turtle Dataset]
- [Exercise 6-1: Introduced Possums in New Zealand]

The Integrative Exercises listed below are referred to in the eBook [[Getting Started with dartR](http://dartr.biomatix.org/dartR)]{style="color:#ff0000;"} and are to be undertaken when you have completed all chapters.

**List of Integrative Exercises**

- [Exercise 7-1: Camaroon Macrobrachium]
- [Exercise 7-2: Western Sawshell Turtle]
- [Exercise 7-3: Northern Quoll]

Don't forget that all aspects of the material are beneficial for learning -- the eBook for an introduction to the theory and methods, the Worked Examples to gain experience with dartR functions and how they are combined in a workflow and finally the Exercises to apply everything you have learned without coaching.

<small>If you can't see the left sidebar, you just need to make the tutorial panel wider.</small>

### R code box

The Worked Examples are interactive in that they present short R scripts in a consoles (like the one below) that needs to be executed. Since you are running the Worked Examples and Excercises from within RStudio, you can also follow along in your own RStudio Console or Editor and evern start start writing your own code as you go along. You could even try testing some of what you learn on your own data.
...
Each R code box is independent so that code you ran in one will not be recognised by another. We have done some fancy coding in the background, keeping track of prior tasks and outputs for you.  

A few of the Exercises are specific to your working environment or to Rstudio. These types of Exercises will have code that you need to run in your own RStudio Editor, along with the output you can expect to generate.

While going through the Worked Examples your progress will be saved, if at any point you would like to refresh the tutorial and start over, a <small>[Start Over]{style="color:#a3a3a3; font-family:'Jaldi', sans-serif;"}</small> button is available.
...
Pick your Worked Example or Exercise from the Menu.
...
First, load in the dataset using `gl.load()` or refer to [Worked Ex 3-1: Data Structures and I/O].
